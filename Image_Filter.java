...
public class Image_Filter extends javax.swing.filechooser.FileFilter
{
	 ...
	 *@param ext Extension of a file *@return Returns true if the extension is 'jpg' or 'png'
	 */
	...
	/*
	 *Determines if the file is a directory or accepted extension *@param f The File to run the directory/proper extension check on
	...
	/*
	 *Supplies File type description *@return Returns the String description */
	...
	/*
	 *Determines the Extension *@param f File to return the extension of
